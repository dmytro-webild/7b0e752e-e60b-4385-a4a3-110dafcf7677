...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/table-setting_74190-1972.jpg",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$22",
          imageSrc: "http://img.b2bpic.net/free-photo/pasta-with-tomatoes-grated-cheese_141793-897.jpg",
        },
      ]}
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Farm to Table",
          description: "100% locally sourced ingredients delivered daily.",
          icon: Leaf,
          mediaItems: [
            {
        ...
        {
          title: "Expert Chefs",
          description: "Masters of their craft with 20+ years of experience.",
          icon: Award,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Hand-mixed drinks to perfectly pair with your meal.",
          icon: Wine,
          mediaItems: [
            {
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        },
        {
          ...
          content: "We offer complimentary valet parking right at our entrance.",
        },
        {
          id: "f3",
